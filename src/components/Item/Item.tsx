...
export const Item = (props:ItemPropsType) => {
    ...
    return (<Link to={`/appartment/${props.item.id}`}><li className="card bordered shadow-md rounded-2xl overflow-hidden">
            ...
            <div className="card-body py-6">
                ...
                <h2 className="text-zappyblack text-lg font-bold mb-4 px-6 h-16 leading-6">{stringCutter(props.item.title, 50)}</h2> 
